...
func TestPrivateFunc_consume(t *testing.T, appId string) {
	...
	wk := server1.NewWorker("sms_worker", 0, appId)
	deliveries := make(chan *awssqs.ReceiveMessageOutput)
	outputCopy := *receiveMessageOutput
...
func TestPrivateFunc_consumeOne(t *testing.T, appId string) {
...
func TestPrivateFunc_startConsuming(t *testing.T, appId string) {
	...
	broker.StartConsumingForTest("fooTag", 1, appId, wk)
...
func TestPrivateFunc_consumeDeliveries(t *testing.T, appId string) {
...
func Test_CustomQueueName(t *testing.T, appId string) {
	...
	wk := server1.NewWorker("test-worker", 0, appId)
...
func TestPrivateFunc_consumeWithConcurrency(t *testing.T) {
	...
	pool <- struct{}{}
	wk := server1.NewWorker("sms_worker", 1, appId)
	deliveries := make(chan *awssqs.ReceiveMessageOutput)
	outputCopy := *receiveMessageOutput
	outputCopy.Messages = []*awssqs.Message{
		{
