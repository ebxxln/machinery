...
func (b *BrokerGR) StartConsuming(consumerTag string, concurrency int, appId string, taskProcessor iface.TaskProcessor) (bool, error) {
	b.consumingWG.Add(1)
...
func (b *BrokerGR) GetPendingTasks(queue, appId string) ([]*tasks.Signature, error) {
